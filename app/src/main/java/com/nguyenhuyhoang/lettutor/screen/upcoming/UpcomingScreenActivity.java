package com.nguyenhuyhoang.lettutor.screen.upcoming;
...
public class UpcomingScreenActivity extends AppCompatActivity implements NavigationBarView.OnItemSelectedListener {
    ...
    void init()
    {
        ...
        mBottomNavigationView.setSelectedItemId(R.id.upcoming_screen);
    }
