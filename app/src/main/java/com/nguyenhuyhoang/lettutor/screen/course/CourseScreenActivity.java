package com.nguyenhuyhoang.lettutor.screen.course;
...
public class CourseScreenActivity extends AppCompatActivity implements NavigationBarView.OnItemSelectedListener {
    ...
    void init()
    {
        ...
        mBottomNavigationView.setSelectedItemId(R.id.course_screen);
    }
